								...
								<div class="row"style="margin-left: 1.2rem; margin-right: 1.2rem;" >
                                         ...
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text"  id="Marca" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Marca']; ?>">
									     </div>
									   </div>                                      
                                         <div class="col">
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text" id="Modelo"  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Modelo']; ?>">
									     </div>
									   </div>
                                    	 <div class="col">
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text"  id="Color" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Color']; ?>">
									     </div>
									   </div>
								...
								<div class="row"style="margin-left: 1.2rem; margin-right: 1.2rem;" >
                                         ...
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text" id="Estado"  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Estado']; ?>">
									     </div>
									   </div>                                      
                                         <div class="col">
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="number" id="GB"  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['GB']; ?>">
									     </div>
									   </div>
                                    	 <div class="col">
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text"  id="Estetica" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Estetica']; ?>">
									     </div>
									   </div>
                                 		 ...
                                 		 <div class="col">
                                           <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text" id="Bateria"  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="">
									     </div>
									   </div>
                                         <div class="col">
                                         <div class="input-group input-group-sm mb-3">
                                 		 ...
                                 		 <div class="col">
                                           <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text" id="Vidrio" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Vidrio']; ?>">
									     </div>
									   </div>
                                         <div class="col">
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text" id="Modulo"  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Modulo']; ?>">
									     </div>
									   </div>                                      
                                         <div class="col">
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text" id="Traslucido"  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" value="<?php echo $row['Traslucido']; ?>">
									     </div>
									   </div>
                                    	 <div class="col">
                                         <div class="input-group input-group-sm mb-3">
                                		...
                                		<div class="col">
                                         <div class="input-group input-group-sm mb-3">
 											 <div class="input-group-prepend">
 												 ...
 												 <input type="text" id="Revisor"  class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
									     </div>
									   </div>   
                                 		 <div class="col">
                                           <div class="input-group input-group-sm mb-3">
