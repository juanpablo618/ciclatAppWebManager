...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <link href="http://localhost/ciclatAppWebManager/html/css/sb-admin-2.css" rel="stylesheet">
...
<body id="page-top" bgcolour="#5a5c69">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="http://localhost/ciclatAppWebManager/html/#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="true" aria-controls="collapsePages">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="http://localhost/ciclatAppWebManager/html/login.html">Ingresar</a>
            <a class="collapse-item" href="http://localhost/ciclatAppWebManager/html/register.html">Registro</a>
            <a class="collapse-item" href="http://localhost/ciclatAppWebManager/html/forgot-password.html">Olivide mi ContraseÃƒÂ±a</a>
    ...
    <!-- Nav Item - Tables -->
      <li class="nav-item">
        ...
        <a class="nav-link" href="http://localhost/ciclatAppWebManager/html/tables2.php">
          <i class="fas fa-fw fa-table"></i>
  ...
  <script src="http://localhost/ciclatAppWebManager/html/vendor/jquery/jquery.min.js"></script>
  ...
  <script src="http://localhost/ciclatAppWebManager/html/js/sb-admin-2.min.js"></script>

  <!-- Page level plugins -->
  <script src="http://localhost/ciclatAppWebManager/html/vendor/datatables/jquery.dataTables.min.js"></script>
  <script src="http://localhost/ciclatAppWebManager/html/vendor/datatables/dataTables.bootstrap4.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="http://localhost/ciclatAppWebManager/html/js/demo/datatables-demo.js"></script>
